...
class PostManager(models.Manager):
    def active(self, *args, **kwargs):
        # Modifying parent Post Manager class with additional filters 
...
# Sending the pre_save signal to the be managed by the a customer function (pre_save_post_receiver) 
